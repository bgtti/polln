"""
Base settings: for dev and prod environments alike.
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # useful for production env
]
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'charset': 'utf8mb4', #check if still works
        },
    }
}
